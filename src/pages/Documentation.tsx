      ...
      <div className="flex">
        ...
        <aside className="hidden lg:block w-72 shrink-0 border-r border-white/10 pt-12 pr-8 lg:ml-24 h-[calc(100vh-64px)] sticky top-16 overflow-y-auto no-scrollbar">
          <div className="relative mb-8">
            ...
            />
            <div className="absolute right-2 top-1/2 -translate-y-1/2 bg-white/10 border border-white/10 rounded px-1.5 py-0.5 text-[10px] text-gray-500 font-sans">
              ⌘K
            </div>
          </div>
        ...
        <main className="flex-1 pt-16 pb-24 px-6 md:px-12 relative flex flex-col items-center">
          ...
          <div className="w-full max-w-4xl flex flex-col items-center text-center">
            ...
            {/* Hero Section */}
            <h1 className="text-1xl md:text-4xl font-bold mb-4 tracking-tight whitespace-nowrap">
              AmbaLay Maps Documentation
            </h1>
            <p className="text-gray-400 text-base md:text-base leading-relaxed mb-6">
              Explore AmbaLay Maps API's features, integrations, and ways of implementation.
            </p>
            
            {/* Buttons */}
            <div className="flex items-center justify-center gap-4 mb-16">
              <button className="bg-white text-black px-8 py-3 rounded-xl text-sm font-bold hover:bg-gray-200 transition-all shadow-lg shadow-white/5">
                Introduction
              </button>
            ...
            <div className="w-full text-left">
              <h2 className="text-3xl font-medium mb-10 tracking-tight">Explore by categories</h2>
